package com.thinkgem.jeesite.modules.crm.visit.web;
...
import com.thinkgem.jeesite.modules.crm.visit.service.VisitService;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/crm/visit")
public class VisitController extends BaseController {

	private static String urlPrefix = "modules/crm/visit/";
	...
	@ModelAttribute
	public ClientVisit get(@RequestParam(required=false) String id) {
	...
	public String list(ClientVisit visit, HttpServletRequest request, HttpServletResponse response, Model model) {
//		client.getSqlMap().put("dsf", BaseService.dataScopeFilter(UserUtils.getUser(), "s5", "u4"));
// 		BaseService.dataScopeFilter(visit, "dsf", "s5.id =id or u4.id is null ", "u4.id = id or u4.id is null");
		
		Page<ClientVisit> page = visitService.findPage(new Page<ClientVisit>(request, response), visit);

		model.addAttribute("page", page);

		model.addAttribute("visit", visit);

		return urlPrefix + "VisitList";
	}

	@RequiresPermissions("client:client:view")
	@RequestMapping(value = "form")
	public String form(ClientVisit visit, Model model) {
		model.addAttribute("visit", visit);

		return urlPrefix + "VisitForm";
	}

	@RequiresPermissions("client:client:view")
	@RequestMapping(value = "formByClient")
	public String formByClient(String clientId, Model model) {
	...
	public String save(ClientVisit visit, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/crm/visit/?repage";
	}
	...
	public String delete(ClientVisit visit, RedirectAttributes redirectAttributes) {
