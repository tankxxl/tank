...
public class ProjectInvoiceItemService extends CrudService<ProjectInvoiceItemDao, ProjectInvoiceItem> {
     ...
     * @return
     */
    public ProjectInvoiceItem get(String id) {
        ProjectInvoiceItem item = super.get(id);
    ...
    public void save(ProjectInvoiceItem projectInvoiceItem) {
        // 父类保存自己
        super.save(projectInvoiceItem);
        // ，保存自己的孩子，如果是重开流程
        // if ( "resign".equals(projectInvoiceItem.getFunc()) ) {
