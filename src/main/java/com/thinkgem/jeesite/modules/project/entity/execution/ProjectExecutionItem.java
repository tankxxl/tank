 ...
 * @version 2016-03-08
 */
public class ProjectExecutionItem extends ActEntity<ProjectExecutionItem> {
...
//    private String supplierOrigin4Export; // for export
    ...
    public ProjectExecutionItem() {
        super();
    }

    public ProjectExecutionItem(String id){
        super(id);
    }

    public ProjectExecutionItem(ProjectExecution execution){
    ...
    @XmlTransient
    public String getSupplierOrigin4Export(){
        if (supplierOrigin == null){
            return "";
        }else{
            return DictUtils.getDictLabels(supplierOrigin, "jic_execution_origin", "");
        }
    }
