...
<script src="${ctxStatic}/jquery-validation/1.17.0/jquery.validate.min.js" type="text/javascript"></script>
<script src="${ctxStatic}/jquery-validation/1.17.0/additional-methods.min.js" type="text/javascript"></script>
<script src="${ctxStatic}/jquery-validation/1.17.0/localization/messages_zh.js" type="text/javascript"></script>
