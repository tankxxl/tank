...
<ul class="nav nav-tabs">
	...
	<li class="active"><a href="${ctx}/crm/client/form?id=${client.id}">客户<shiro:hasPermission name="client:client:edit">${not empty client.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="client:client:edit">查看</shiro:lacksPermission></a></li>
</ul><br/>
<form:form id="inputForm"
	modelAttribute="clientVisit"
	action="${ctx}/crm/client/save4Visit"
	...
	<div class="control-group">
		...
		<sys:treeselect id="principal" name="principal.id" value="${client.principal.id}" labelName="principal.name" labelValue="${client.principal.name}"
	...
	<div class="control-group">
		<label class="control-label">客户地点：</label>
		<div class="controls">
