...
<body>
	...
	<form:form id="inputForm" modelAttribute="projectFinishApproval" action="${ctx}/project/finish/projectFinishApproval/saveAudit" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="project:finish:projectFinishApproval:edit">
				<c:if test="${projectFinishApproval.act.taskDefKey ne 'apply_end'}">
