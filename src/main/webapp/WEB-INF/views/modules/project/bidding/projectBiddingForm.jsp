...
<form:form id="inputForm" modelAttribute="projectBidding" htmlEscape="false"
	...
	<table class="table-form">
		...
		<tr>
			...
			<td class="" colspan="3">
				<form:input path="tenderer" style="width:90%" maxlength="500" class="input-medium "/>
			</td>
		...
		<tr>
			...
			<td class="" colspan="5">
				<div style="white-space:nowrap;">
					<form:textarea path="content" style="width:98%" rows="4" maxlength="2000" class="input-medium "/>
				</div>
			</td>
		</tr>
		<tr>
