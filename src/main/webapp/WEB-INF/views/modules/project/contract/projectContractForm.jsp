...
<form:form id="inputForm" modelAttribute="projectContract" action="${ctx}/project/contract/projectContract/save" htmlEscape="false" method="post" class="form-horizontal">
	<form:hidden path="id"/>
