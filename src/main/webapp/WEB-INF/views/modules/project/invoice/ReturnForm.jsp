...
<form:form id="inputForm" modelAttribute="projectInvoice" htmlEscape="false"
    ...
    <div class="">
        ...
        <tr id="invoiceItemList{{idx}}">
            ...
            <td>
                <input id="invoiceItemList{{idx}}_costAmount" name="invoiceItemList[{{idx}}].costAmount" type="text" style="width:90%"
                value="{{row.costAmount}}" maxlength="25" decimal="true" number="true" min="0" max="99999999" class="checkNum input-small" required/>
            </td>
